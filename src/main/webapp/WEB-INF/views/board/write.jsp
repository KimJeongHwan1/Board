...
<tr>
   ...
   <td style="width: 80%"><input type="text" name="content_title" id="content_title" placeholder="게시물 제목" style="width: 498px;"/></td>
</tr>
<tr>
...
<tr>
   ...
   <td style="width: 80%"><input type="radio" value="0" name="basic" id="basic" checked="checked"/>일반
   						  <input type="radio" value="1" name="basic" id="special"/>중요
   	</td>
</tr>
<tr>
   <td>파일첨부</td>
